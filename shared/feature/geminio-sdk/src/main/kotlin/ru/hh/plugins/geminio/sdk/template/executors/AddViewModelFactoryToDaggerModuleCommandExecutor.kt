...
internal fun RecipeExecutor.execute(
    ...
    HHLogger.d("AddViewModelFactoryToDaggerModule command [$command]")
    ...
    val featureComponentPath = File(componentPath).toPsiDirectory(executorData.project) ?: return
    ...
    val featureComponentClassBodyPsi =
        featureComponentClassPsi.children.find { it is KtClassBody } as? KtClassBody ?: return@with
